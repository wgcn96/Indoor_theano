...
configFileURL = '/home/rootcs412/wangchen/work/Indoor/config/0117train_1.conf'
...
updates.update(lasagne.updates.momentum(cost,lasagneParamsList[60:90],sh_lr))
updates.update(lasagne.updates.momentum(cost,lasagneParamsList[90:92],stn_lr_mul*sh_lr))
updates.update(lasagne.updates.momentum(cost,lasagneParamsList[92:],sh_lr))
