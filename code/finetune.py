...
#global Variant
configFileURL = '/media/wangchen/newdata1/wangchen/work/Indoor/config/0110train_1.conf'
...
detailFile_url = config.getKeyValue('detailFile_url')
...
net_vgg_Dict = build_vgg_model(inputLayer=net_input, prefix=net_prefix, classificationFlag=True)
...
try:
    ...
    for n in range(num_epoches):
        ...
        if test_acc > max_test_acc:
            ...
            idx = n+1
            matrixTable, lineDetail = confusionMatrix(test_label,y_hat)
            matrixToExcel(matrixTable,matrixTable_url)
