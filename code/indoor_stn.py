...
configFileURL = '/media/wangchen/newdata1/wangchen/work/Indoor/config/1220train_2.conf'
...
reload_image_url = '/media/wangchen/newdata1/wangchen/work/Indoor/models/caffe_vgg16_image.pkl'
reload_places_url = '/media/wangchen/newdata1/wangchen/work/Indoor/models/caffe_vgg16_places.pkl'
...
count2 = copyParams(lasagneLayersList[23:41],copyImageParamsList)
...
#count5 = copyParams(lasagneLayersList[91],copyPlacesParamsList[30:])
...
'''
updates = lasagne.updates.momentum(cost,lasagneParamsList,sh_lr,momentum=0.9)
