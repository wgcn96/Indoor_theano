...
#global Variant
configFileURL = '/media/wangchen/newdata1/wangchen/work/Indoor/config/1228train_2.conf'
...
count = copyParams_bn(lasagneLayerList, copyParamsList)


print prefix.format(wangchendebug) + 'build model and copy params finish!'
print '\tcopy params are: {0}'.format(count)
wangchendebug += 1
...
try:
    ...
    for n in range(num_epoches):
        ...
        if test_acc > max_test_acc:
            ...
            idx = n+1
            saveModel(model_url,lasagne.layers.get_all_param_values(net_vgg_last_layer))
